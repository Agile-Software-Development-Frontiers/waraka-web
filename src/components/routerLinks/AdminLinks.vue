...
<template>
  ...
  <el-menu-item index="firm-list">
    ...
    <template #title>
      <span class="text-size">All Emails</span>
    </template>
  </el-menu-item>
  ...
  <el-menu-item index="create-firm">
    ...
    <template #title>
      <span class="text-size">Unread</span>
    </template>
  </el-menu-item>
  ...
  <el-menu-item index="create-firm">
    ...
    <template #title>
      <span class="text-size">Spam</span>
    </template>
  </el-menu-item>
  ...
  <el-menu-item index="firm-list">
    ...
    <template #title>
      <span class="text-size">Compose Mail</span>
    </template>
  </el-menu-item>


  <el-menu-item class="hidden"
                index="welcome">
    <el-icon size="30">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-8">
    ...
    <template #title>
      <span class="text-size">Domain Setup</span>
    </template>
  </el-menu-item>
